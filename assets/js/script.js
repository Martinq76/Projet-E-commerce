...
$('.addButton').click(function() {
      var index = $(this).val();
      console.log(index);
      var tableau = '<tr><td>' + nameProducts[index] + '</td><td>' + code[index] + '</td><td>' + price[index] + '€' + '</td><td>' + '<input type="number" id="quantityCaddy" value="1" />' + '</td></tr>';
      ...
      var ma_variable = $("#quantityCaddyup").val();
